...
# ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
# 
# WHY THIS MATTERS (The "Toggle" Safety Feature):
# ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
# 
# The framework uses regex pattern matching as a "toggle":
#   - Pattern: r'^[A-Z_][A-Z0-9_]*$'  ← ONLY matches UPPERCASE
#   - This prevents accidentally using OLD generated snippets
#   - Ensures each run uses YOUR explicit input, not cached output
#
# CORRECT Workflow (Iterative Composition):
# ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
# 
# Step 1 - First Study:
#   THEME_A = r"""\\relative c'' {{ c4 d e f }}"""  ← UPPERCASE input
#   VOICE_STAVE_DATA = """transpose_part(THEME_A, 'P5')"""
#   → Generates: outputs/ file with Station 2 snippet:
#       transpose_part_THEME_A_P5 = r"""g4 a b c'"""  ← lowercase output
#
# Step 2 - Next Study (iterative composition):
#   # Copy from Station 2, RENAME to UPPERCASE:
#   TRANSPOSED_THEME = r"""g4 a b c'"""  ← NEW UPPERCASE name!
#   VOICE_STAVE_DATA = """retrograde_part(TRANSPOSED_THEME)"""
#   → Generates NEW transformation (second-generation)
#
# ❌ WRONG - Will NOT Work:
#   VOICE_STAVE_DATA = """transpose_part_THEME_A_P5"""  ← lowercase ignored!
#   → ERROR: "Snippet 'transpose_part_THEME_A_P5' not found"
#
# ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
#
# BEST PRACTICES:
...
def generate_study(number, title=None, output_dir='studies'):
    ...
    Args:
        number: Study number (e.g., 18)
        title: Custom title (default: "Feature Demonstration")
        output_dir: Output directory (default: 'studies')
    """
    ordinal = number_to_ordinal(number)
    title_upper = ordinal.upper()
    custom_title = title or "Feature Demonstration"
...
def main():
    if len(sys.argv) < 2:
        ...
        print("=" * 70)
        print()
        print("Usage: python generate_study.py <number> [title]")
        print()
        print("Examples:")
        ...
        while True:
            try:
                number_input = input("Enter study number (or 'q' to quit): ").strip()
                if number_input.lower() in ['q', 'quit', 'exit']:
                    print("Cancelled.")
                    sys.exit(0)
