"""
100TH STUDY: Feature Demonstration
===================================
...
TITLE = "100TH Study: Feature Demonstration"
...
def build_score_data() -> Dict:
    ...
    print("\n" + "="*70)
    print("100TH STUDY: Blueprint String Framework")
    print("="*70)
    ...
    # --- AUTO-PARSE and Build Score ---
    # No need for snippets_to_parse dictionary!
    # Framework automatically detects THEME_A, THEME_B, BASS_FIGURE, HARMONY_CHORDS
    # from VOICE_STAVE_DATA and parses them
...
def build_score_data_programmatic() -> Dict:
    ...
    print("\n" + "="*70)
    print("100TH STUDY: Programmatic Assembly (Station 4)")
    print("="*70)

    # --- STATION 1 → Parse Snippets ---
    print("\n[Station 1 Parsing] Loading base materials...")
    
    theme_a_data = parse_lilypond_to_data(THEME_A, part_name='THEME_A')
    theme_b_data = parse_lilypond_to_data(THEME_B, part_name='THEME_B')
    bass_data = parse_lilypond_to_data(BASS_FIGURE, part_name='BASS')
