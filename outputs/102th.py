...
# ============================================================================
# These are EDITABLE LilyPond snippets in absolute notation.
# You can copy and modify these snippets for reuse in other studies!
#
# ⭐ ALL snippets are included:
#    - Original snippets from Station 1 (your LilyPond input)
#    - Transformed snippets from Station 3 (transpose, retrograde, etc.)
#
# 📝 Notation format: Absolute (octave 3 = baseline)
#    c  = C3,  c' = C4,  c'' = C5
#    c, = C2,  c,, = C1
#
# Usage in other studies:
#   1. Copy any snippet below (e.g., THEME_A = r\"\"\"...\"\"\")
#   2. Paste into your new study's Station 1
#   3. Edit the LilyPond code as needed
#   4. Use the snippet name in VOICE_STAVE_DATA
# ============================================================================

THEME_A = r"""
d'''4-.\p f'''8 g'''8 a'''4~ | a'''4 g'''4-> f'''4 | e'''4. d'''8~ d'''4 | b'''4\f c''''4 d''''4
"""

THEME_B = r"""
d'''4-.\f g'''8 g'''8 a'''4~ | a'''4 g'''4-> fis'''4 | e'''4. d'''8~ d'''4 | b'''4\ff c''''4 d''''4
"""

retrograde_part_THEME_A = r"""
d''''4 c''''4 b'''4 d'''4 d'''8 e'''4. f'''4 g'''4 a'''4 a'''4 g'''8 f'''8 d'''4
"""

transpose_part_THEME_A_P5 = r"""
a'''4 c''''8 d''''8 e''''4 | e''''4 d''''4 c''''4 | b'''4. a'''8 a'''4 | fis''''4 g''''4 a''''4
"""

# Total snippets in Station 2 library: 4
