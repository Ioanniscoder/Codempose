...
from src.composition_shorthand import transpose_events, invert_events, filter_events
...
def build_score_data() -> Dict:
    ...
    augmented_events = []
    # Filter out barlines before augmentation (barlines are rendering artifacts)
    subject_notes_only = filter_events(subject_events, exclude_types=['barline'])
    for event in subject_notes_only:
